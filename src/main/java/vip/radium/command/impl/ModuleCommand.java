...
public class ModuleCommand implements Command {
    ...
    public void execute(String[] arguments) throws CommandExecutionException {
        ...
        if(property == null) {
            mc.addChatMessage(EnumChatFormatting.RED + arguments[1] + " \u00A77Invalid Property");
            return;
        }
        ...
        try {
            if (property.getType() == Boolean.class) {
                ...
                mc.addChatMessage("Property \u00A76" + property.getLabel() + " \u00A77set to \u00A76" + property.getValue());
                ...
                Arrays.stream(enumProperty.getValues()).filter(option -> option.name().equalsIgnoreCase(arguments[2])).forEach(option -> {
                    ...
                    mc.addChatMessage("Property \u00A76" + enumProperty.getLabel() + " \u00A77set to \u00A76" + enumProperty.getValue());
                });
            }
        } catch (Exception e) {
            mc.addChatMessage(EnumChatFormatting.RED + arguments[2] + " \u00A77Invalid Type");
        }
    }
