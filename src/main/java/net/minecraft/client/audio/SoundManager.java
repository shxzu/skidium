...
public class SoundManager
{
    ...
    public void playSoundFromFile(String fileName, double x, double y , double z) {
        SoundSystemConfig.setSoundFilesPackage("assets/minecraft/radium/sounds/");
        ...
        sndSystem.setVolume("hitmarker", (float) (RadiumClient.getInstance().getModuleManager().getModule(Hitmarkers.class).volumeProperty.getValue() / 100));
